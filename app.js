...
function setupEventListeners() {
  ...
  if (settingsBtn) {
    settingsBtn.addEventListener('click', () => {
      const savedUrl = localStorage.getItem('phjh_teacher_script_url') || 'https://script.google.com/macros/s/AKfycbwEf_DfqE2C5A9F9nh2PCLS4PPoqR54WapfbXBl-A-DAq_PSxUcS0e2ta5DoPl6DvcKFg/exec';
...
function submitWorksheet(weekNo, data) {
  const url = 'https://script.google.com/macros/s/AKfycbwEf_DfqE2C5A9F9nh2PCLS4PPoqR54WapfbXBl-A-DAq_PSxUcS0e2ta5DoPl6DvcKFg/exec';
  if (!url) {
